            ...
            <div className='w-[85%] md:w-[30%] shadow-lg bg-white rounded-lg mt-10 p-6 box-border'>
                <div className='flex flex-col gap-4'>
                    <div>
                        ...
                        <input type="text" className='w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Enter your full name' />
                        ...
                        <input type="password" className='w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Confirm your password' />
                        <div className='mt-4'>
                            <button className='w-full bg-orange-400 text-white py-3 rounded-md hover:bg-orange-500 cursor-pointer'>Sign Up</button>
                        </div>

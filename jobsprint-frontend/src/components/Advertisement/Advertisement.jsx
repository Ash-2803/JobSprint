            ...
            <Card padding={0}>
                <div className='relative h-25'>
                    ...
                    <div className='absolute top-15 left-[40%] z-10'>
                        <img src={MyImage} className="rounded-full border-2 h-14 w-14 border-white cursor-pointer object-cover" alt="My Image" />
                    </div>
                </div>
                <div className='px-10 py-5'>
            <div className='text-sm font-semibold my-1 text-center'>Advertise with JobSprint</div>
